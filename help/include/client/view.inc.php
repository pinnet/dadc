...
<table width="500" cellpadding="1" cellspacing="0" border="0" id="ticketInfo">
    <tr>
...
if($ticket->getThreadCount() && ($thread=$ticket->getClientThread())) {
    ...
    foreach($thread as $entry) {
        ...
        if($entry['thread_type']=='R' && ($cfg->hideStaffName() || !$entry['staff_id']))
            $poster = ' ';
        ?>
        <table class="thread-entry <?php echo $threadType[$entry['thread_type']]; ?>" cellspacing="0" cellpadding="1" width="500" border="0">
            <tr><th><div>
